...
mapping = {
    ...
    'sahifa-sajjadiya-the-supplication-for-sunday': 'الصحيفة السجادية - دعاء يوم الأحد',
...
# Replace the keys in ar-fusha and ar-iraqi
for k, v in mapping.items():
    key_name = 'title_' + k.replace('-', '_')
    # Find the line in ar-fusha and replace it
    pattern_ar = r'(' + key_name + r':\s*)"الصحيفة السجادية -[^"]*"'
    content = re.sub(pattern_ar, r'\1"' + v + '"', content)
